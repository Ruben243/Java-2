...
Escriba un programa que permita al usuario dibujar una figura con el ratón. La figura a dibujar deberá determinarse mediante un evento KeyEvent, utilizando las siguientes teclas: o dibuja un óvalo, r dibuja un rectángulo y l dibuja una línea. El tamaño y la ubicación de la figura deberán determinarse mediante los eventos mousePressed y mouseReleased. Muestre el nombre de la figura actual en un objeto Jlabel que se encuentre en la región SOUTH de un esquema BorderLayout. La figura inicial predeterminada deberá ser un ovalo.
...
class Ventana extends JFrame { 
	...
	private JLabel etiquetaMostrarFigura;
	...
	public Ventana () {
	    ...
	    super ("Dibujar figuras, eventos teclas");
	    ...
	    etiquetaMostrarFigura = new JLabel ();
	    contenedor.add (etiquetaMostrarFigura, BorderLayout.SOUTH);
	    etiquetaMostrarFigura.setText ("Figura seleccionada " + nombreFiguras[figura]);
